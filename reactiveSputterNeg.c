...
int main()
  {
    ...
    fclose(ov);
    printf("\ncalculated values for p_N, F, theta_1, theta_2, q_t, q_c, q_p, q_0, Y written to output.dat, plotting to NegYOverq_0.ps and NegP_NOverq_0.ps\n");
    system("gnuplot plotNegYOverq_0.gnu; gnuplot plotNegP_NOverq_0.gnu");
    return 0;
  }
